...
def img_url_filter(filename):
    """Resolve an image reference for <img src>.
    If it's already a full URL (S3, Cloudinary, http/https), use it as-is.
    Otherwise treat it as a local filename under static/images/."""
    if not filename:
        return ""
